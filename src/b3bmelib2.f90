...
subroutine findTRpairs(it)
   ...
   do ipair = 1,npairXX(it)
       XX2(it)%pair(ipair)%tr = -1
       XX2(it)%pair(ipair)%trphase = 0
   end do
   do ipair = 1,npairXX(it)-1
