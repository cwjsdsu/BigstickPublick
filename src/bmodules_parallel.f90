...
#ifdef _BD3   
   logical :: useHZSomp = .false.    ! temp turned off
#else
...
!... ADDED BY CWJ in 7.10.9 as part of MPI upgrade
    integer(4) :: fcomm1_index,fcomm2_index ! used to tell whether to use fcomm1 or fcomm2   
...
!   these cause problems in distributing work and must be accounted for separately
  ...
  logical :: use_greedy = .true. ! flag to separate out greedy opbundles into separate MPI ranks
