...
!  else            "right" states
!
!  Also compute nhsps_eff(ith) ADDED 7.10.8
!
!  CALLED BY:
!      main routine
!      getWlimits
...
! added 7.10.8 to address problems with sterile orbits W = 99

do it = 1,2   
   if(hspsqn(it,1)%w > 98)then
 	  print*,' Something has gone wrong with assigning W = 99 '
 	  stop
   end if
