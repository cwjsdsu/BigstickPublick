...
101 format(i7,i12,6x,2i8)
 ...
 write(logfile,*)' sector information written to file '
 write(logfile,*)' Total of ',nsectors(1),' sectors '
 write(logfile,*) ' with max of ',maxsector,' states in a sector '
  write(logfile,*)' With ',nbigsectors,' greater than limit of ',maxfragmentsize,' (var: maxfragmentsize) '
