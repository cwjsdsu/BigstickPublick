...
module basis
  ...
  integer(kind=basis_prec),allocatable,target :: pstart(:),nstart(:)   ! used for finding basis

!..... ADDED 7.10.8 to make determining parity in 'parity = 0' case possible
  
  logical,allocatable, target :: pparity(:),nparity(:)
